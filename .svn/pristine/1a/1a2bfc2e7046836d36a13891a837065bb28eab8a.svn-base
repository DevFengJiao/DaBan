...
#import "MSBaseChatViewController.h"
...
@interface MSBaseChatViewController ()<AVIMClientDelegate>

@end

@implementation MSBaseChatViewController
...
//        _messageToolBar.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleRightMargin;
...
//        _messageToolBar.moreView = [[DXChatBarMoreView alloc] initWithFrame:CGRectMake(0, (kVerticalPadding * 2 + kInputTextViewMinHeight), _messageToolBar.frame.size.width, 80) typw:type];
//        _messageToolBar.moreView.backgroundColor = MK_RGBACOLOR(240, 242, 247, 1);
