...
//    if (_isSendLocation) {
        ...
        UIButton *sendButton = [[UIButton alloc] initWithFrame:CGRectMake(35, 0, 60, 44)];
        sendButton.backgroundColor = [UIColor clearColor];
        [sendButton setTitle:NSLocalizedString(@"发送", @"Send") forState:UIControlStateNormal];
        [sendButton setTitleColor:ZI_NACOLOR forState:UIControlStateNormal];
//        [sendButton setTitleColor:ZI_NACOLOR forState:UIControlStateHighlighted];
